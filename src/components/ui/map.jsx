...
/**
 * WorldMap – dotted world map with animated paths between locations.
 * Adapted for Vite/React (no Next.js). Uses theme prop for light/dark.
 */
export function WorldMap({
  ...
  const mapSvgUrl = `data:image/svg+xml;utf8,${encodeURIComponent(svgMap)}`;
